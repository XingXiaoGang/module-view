...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = (int) Utils.dp2px(0f, getContext());
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = (int) Utils.dp2px(0f, getContext());
    private int mLabelsVerticalOffset = (int) Utils.dp2px(0f, getContext());
    ...
    private int mLabelsPaddingTop = (int) Utils.dp2px(4f, getContext());
    private int mLabelsPaddingRight = (int) Utils.dp2px(8f, getContext());
    private int mLabelsPaddingBottom = (int) Utils.dp2px(4f, getContext());
    private int mLabelsPaddingLeft = (int) Utils.dp2px(8f, getContext());
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = (int) Utils.dp2px(3f, getContext());
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mIcon == null) {
            mIcon = getResources().getDrawable(R.drawable.icon_add_fab);
        }
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = (int) Utils.dp2px(mMenuShadowRadius, getContext());
            mMenuButton.mShadowXOffset = (int) Utils.dp2px(mMenuShadowXOffset, getContext());
            mMenuButton.mShadowYOffset = (int) Utils.dp2px(mMenuShadowYOffset, getContext());
        }
